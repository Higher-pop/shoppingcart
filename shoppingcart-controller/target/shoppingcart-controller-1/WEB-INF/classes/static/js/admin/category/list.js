...
$(function () {
    //注册一个全局的ajax错误处理函数，不让会编程人知道我报哪里的错
...
//查询所有分类信息
    function getAll(){
        $.getJSON("/admin/category/list",function (data) {
            ...
            $.each(data,function(index,category){
            	...
            	var $tr = $("<tr><td></td><td></td><td><a href='#' class='delete btn btn-danger  '>删除</a><a href='#' class='edit btn btn-info '>编辑</a></td></tr>");
    ...
    $("tbody").on("click",".delete",function (e) {
        ...
        var $that = $(this);//就是e，在这里从集合单独具体到一个了
        if (confirm("确定要删除吗?")) {
