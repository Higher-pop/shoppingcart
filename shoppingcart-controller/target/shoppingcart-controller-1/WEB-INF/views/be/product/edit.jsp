    ...
    <div class="row clearfix">
        ...
        <div class="col-md-10 column">
            ...
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="/admin/product/update">
                ...
                <input type="hidden"   name="oldimage" id="oldimage" value="${product.pimage}"/>
                <div class="form-group">
                    <label for="multipartFile" class="col-sm-2 control-label">图片</label>
                    <div class="col-sm-6">
                        <input type="file"   name="multipartFile" id="multipartFile"  class="form-control">
                        <%--<input type="hidden"   name="pimage" id="pimage"  class="form-control">--%>
                    </div>
                </div>
                <div class="form-group">
